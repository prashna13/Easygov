...
GOV_SERVICES_DATA = [
    ...
    },
    {
        ...
        "guidance": (
            ...
            "7. Wait for processing (normal 15–45 days at a District/Area Administration Office; fast-track ~2 working days at the Department of Passports only).\n"
            ...
            "- 34-page regular: NPR 12,000 | 34-page fast-track: NPR 19,000\n"
            "- 66-page regular: NPR 20,000 | 66-page fast-track: NPR 32,000\n"
            "- Minor under 10, 34-page: NPR 9,500\n"
            "- Abroad: approx. USD 50–150\n\n"
            "PROCESSING TIME\n"
            "- Regular: 15–45 days\n"
            "- Urgent/fast-track: about 2 working days\n"
    ...
    },
    {
        ...
        "guidance": (
            ...
            "- Smart card printing/delivery: typically 15–45 days after passing both tests\n\n"
            "RENEWAL\n"
